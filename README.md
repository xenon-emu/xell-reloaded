...
# Menu:
Parses bootentries, shows a user controlable menu with XboxController/UART/IR Remote
...
5. Navigate to the desired bootentry. You can do this in the following ways (see below step 6)
